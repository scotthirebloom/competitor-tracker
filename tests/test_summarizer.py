...
class SummarizerTests(unittest.TestCase):
    def test_ensure_pricing_priority_injects_pricing_bullet_when_missing(self):
        ...
        self.assertTrue(lines[0].startswith("• TechDesk pricing update:"))
        self.assertLessEqual(len(lines), 4)

    def test_ensure_pricing_priority_does_not_duplicate_existing_pricing_bullet(self):
        summary = (
            "• TechDesk shifted to credit-based pricing for AI agents.\n"
        ...
        out = _ensure_pricing_priority(summary, reports, max_bullets=4)
        lines = out.splitlines()
        self.assertEqual(lines[0], "• TechDesk shifted to credit-based pricing for AI agents.")
    ...
    def test_normalize_competitor_signal_card_enforces_structure(self):
        ...
        out = _normalize_competitor_signal_card(raw, "Acme Corp")
        self.assertTrue(out.startswith("Competitor: Acme Corp\nSignals:\n"))
